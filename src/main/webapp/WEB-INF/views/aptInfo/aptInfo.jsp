        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card dashboard-product font-weight-bold mx-3">
                            ...
                            <div class="col-xl-12 align-self-center">
                                <form action="/aptInfo/aptInfo" method="get">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-1 pb-1">
                                            <button type="submit" class="btn btn-flat flat-primary text-primary waves-effect waves-light w-100" id="infoserach" value="normal" name="search">검 색</button>
                                        </div>	
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-md-12">
                        <div class="card dashboard-product font-weight-bold mx-3">
                            <form action="/aptInfo/aptInfo" method="post">
                                    ...
                                    <table class="table table-hover table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">개포동</td>
                                                <td><a href="/aptInfo/aptInfoDetail">SH대치1단지 아파트 ${i} <span class="badge rounded-pill bg-success">New</span> </a></td>
                                                <td class="text-center">1991</td>
                                                <td class="text-center">서울특별시 강남구 개포로 109길 5</td>
                                                <td class="text-center">서울특별시 강남구 개포동 12</td>
                                            </tr>
                                            </c:forEach>
                                            <!-- <c:forEach var="n" items="${list }">	
                                                <tr>
                                                    ...
                                                    <td class="text-center text-primary i_apt_name" style="cursor:pointer">${n.apt_name }</td>
                                                    <td class="text-center">${n.construction_year }</td>
                                                    <td class="text-center">${n.address_road }</td>
                                                    <td class="text-center">${n.address_jibun }</td>
                                                </tr>
                                            </c:forEach> -->
                                        </tbody>
                                    </table>
